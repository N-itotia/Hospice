...
<body>
    ...
    <!-- Start Services 
    ============================================= -->
    <div class="tabs-services-area default-padding">
        <div class="container">
                        ...
                        <div id="tabsContent" class="tab-content wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <div id="tab1" class="tab-pane fade active show">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 info">
                                        <h3>Welcome To Our Medical Checkup Department</h3>
                                        <p>
                                            Delightful unreserved impossible few estimating men favourable see entreaties. She propriety immediate was improving. He or entrance humoured likewise moderate. Much nor game son say feel. Fat make met can must form into gate. Me we offending prevailed discovery. 
                                        </p>
                                        <a class="btn btn-md btn-gradient circle" href="#"><i class="fas fa-angle-right"></i> Read More</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="tab2" class="tab-pane fade">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 info">
                                        <h3>Welcome to our Cardiology Department</h3>
                                        <p>
                                            Delightful unreserved impossible few estimating men favourable see entreaties. She propriety immediate was improving. He or entrance humoured likewise moderate. Much nor game son say feel. Fat make met can must form into gate. Me we offending prevailed discovery. 
                                        </p>
                            ...
                            <div id="tab3" class="tab-pane fade">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 info">
                                        <h3>Welcome to our Dental care Department</h3>
                                        <p>
                                            Delightful unreserved impossible few estimating men favourable see entreaties. She propriety immediate was improving. He or entrance humoured likewise moderate. Much nor game son say feel. Fat make met can must form into gate. Me we offending prevailed discovery. 
                                        </p>
                                        <a class="btn-simple" href="#"><i class="fas fa-angle-right"></i> Read More</a>
                            ...
                            <div id="tab4" class="tab-pane fade">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 info">
                                        <h3>Welcome to our Neurology Department</h3>
                                        <p>
                                            Delightful unreserved impossible few estimating men favourable see entreaties. She propriety immediate was improving. He or entrance humoured likewise moderate. Much nor game son say feel. Fat make met can must form into gate. Me we offending prevailed discovery. 
                                        </p>
                                        <a class="btn-simple" href="#"><i class="fas fa-angle-right"></i> Read More</a>
