...
<body>
            ...
            <div class="services-box">
                <div class="services-carousels services-one-item-carousel owl-carousel owl-theme">
                    ...
                    <div class="services-single">
                        <div class="row">
                            <div class="col-lg-5 thumb bg-cover" style="background-image: url(assets/img/800x800.png);"></div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 info">
                    <div class="top-info">
                        <div class="fun-factor-items">
                            <div class="fun-fact">
                                <span class="medium">Doctors</span>
                                <div class="timer" data-to="38" data-speed="2000">38</div>
                            </div>
                            <div class="fun-fact">
                                <span class="medium">Nurse</span>
                    ...
                    <p>
                        We leaf to snug on no need. Way own uncommonly travelling now acceptance bed compliment solicitude. Dissimilar admiration so terminated no in contrasted.
                    </p>
                    <p>
                        Demesne far hearted suppose venture excited see had has. Dependent on so extremely delivered by. Yet ﻿no jokes worse her why. Bed one supposing breakfast day fulfilled off depending questions. Whatever boy her exertion his extended. 
                    </p>
                    <div class="button">
                        <a class="btn btn-gradient btn-md circle" href="#">Doctors List</a>
                    </div>
                </div>
    ...
    <!-- Star Testimonilas
    ============================================= -->
    <div class="testimonials-area health-tips-area default-padding">
        <div class="container">
