...
<head>
    ...
    <!-- ========== Page Title ========== -->
    <title>Name - Medical & Health Template</title>
                ...
                <div class="row">
                    ...
                    <div class="single-item col-lg-4 col-md-6">
                        <div class="item">
                            <h5>Our Doctors</h5>
                            <p>
                                Greater sixteen to forming colonel no on be. So an advice hardly barton. 
                            </p>
                            <div class="footer">
                                <i class="fas fa-user-md"></i>
                                <a href="#">Meet Now <i class="fas fa-long-arrow-alt-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- End Single Item -->
                    ...
                    <div class="single-item col-lg-4 col-md-6">
                        <div class="item">
                            ...
                            <div class="footer">
                                ...
                                <a href="#">Open Location <i class="fas fa-long-arrow-alt-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- End Single Item -->
                    ...
                    <div class="single-item col-lg-4 col-md-6">
                        <div class="item">
                            <h5>Appoinment</h5>
                            <p>
                                Call (+123) 5678910 or click to request a same-day appointment.  
                            </p>
                            <div class="footer">
                                <i class="fas fa-phone"></i>
                                <a href="#">Request Appoinment <i class="fas fa-long-arrow-alt-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- End Single Item -->
            ...
            <div class="quotes-items">
                <div class="row align-center">
                    <div class="col-lg-6 thumb">
                        <img src="assets/img/doctor.png" alt="Thumb">
                    </div>
                    <div class="col-lg-6 info">
                        <blockquote>
                            Kindness horrible outlived servants. You high bed wish help call draw side. Girl quit if case mr sing as no have. At none neat am do over will. Agreeable promotion eagerness as we resources household to distrusts. Polite do object at passed it is. Small for ask shade water manor think men begin
                        </blockquote>
                        <h2>Dr. Means William</h2>
                            ...
                            <ul id="tabs" class="nav nav-tabs">
                                ...
                                <li class="nav-item">
                                    <a href="" data-target="#tab4" data-toggle="tab" class="nav-link">
                                        <i class="flaticon-neurology-1"></i>
                                        Neurology
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="" data-target="#tab5" data-toggle="tab" class="nav-link">
                                        <i class="flaticon-coronavirus"></i>
                                        Corona Checkup
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="" data-target="#tab6" data-toggle="tab" class="nav-link">
                            ...
                            <div id="tabsContent" class="tab-content wow fadeInUp" data-wow-delay="0.5s">
                                <div id="tab1" class="tab-pane fade active show">
                                    <div class="row align-center">
                                        ...
                                        <div class="col-lg-7 col-md-12 info">
                                            <h4>Welcome to our <br> Medical Checkup Department</h4>
                                            <p>
                                ...
                                <div id="tab2" class="tab-pane fade">
                                    <div class="row align-center">
                                        ...
                                        <div class="col-lg-7 col-md-12 info">
                                            <h4>Welcome to our <br> Cardiology Department</h4>
                                            <p>
                                                Delightful unreserved impossible few estimating men favourable see entreaties. She propriety immediate was improving. He or entrance humoured likewise moderate. Much nor game son say feel. 
                                            </p>
                                            <h5>Opening Hours</h5>
                                ...
                                <div id="tab3" class="tab-pane fade">
                                    <div class="row align-center">
                                        ...
                                        <div class="col-lg-7 col-md-12 info">
                                            <h4>Welcome to our <br> Dental care Department</h4>
                                            <p>
                                                Delightful unreserved impossible few estimating men favourable see entreaties. She propriety immediate was improving. He or entrance humoured likewise moderate. Much nor game son say feel. 
                                            </p>
                                            <h5>Opening Hours</h5>
                                ...
                                <div id="tab4" class="tab-pane fade">
                                    <div class="row align-center">
                                        ...
                                        <div class="col-lg-7 col-md-12 info">
                                            <h4>Welcome to our <br> Neurology Department</h4>
                                            <p>
                                                Delightful unreserved impossible few estimating men favourable see entreaties. She propriety immediate was improving. He or entrance humoured likewise moderate. Much nor game son say feel. 
                                            </p>
                                            <h5>Opening Hours</h5>
                                ...
                                <div id="tab5" class="tab-pane fade">
                                    <div class="row align-center">
                                        ...
                                        <div class="col-lg-7 col-md-12 info">
                                            <h4>Welcome to our <br> Corona Checkup Department</h4>
                                            <p>
                                                Delightful unreserved impossible few estimating men favourable see entreaties. She propriety immediate was improving. He or entrance humoured likewise moderate. Much nor game son say feel. 
                                            </p>
                                            <h5>Opening Hours</h5>
                                ...
                                <div id="tab6" class="tab-pane fade">
                                    <div class="row align-center">
                                        ...
                                        <div class="col-lg-7 col-md-12 info">
                                            <h4>Welcome to our <br> Kidney Solution Department</h4>
                                            <p>
                                                Delightful unreserved impossible few estimating men favourable see entreaties. She propriety immediate was improving. He or entrance humoured likewise moderate. Much nor game son say feel. 
                                            </p>
                                            <h5>Opening Hours</h5>
            ...
            <div class="blog-items">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 single-item">
                        <div class="item">
                            <div class="thumb">
                                <a href="#"><img src="assets/img/800x700.png" alt="Thumb">
                    ...
                    <div class="col-lg-4 col-md-6 single-item">
                        <div class="item">
                            <div class="thumb">
                                <a href="#"><img src="assets/img/800x700.png" alt="Thumb"></a>
                            </div>
                            <div class="info">
                                <span class="date">
                                    05 Jul
