...
<body>
    ...
    <header id="home">
        ...
        <!-- Start Navigation -->
        <nav class="navbar navbar-default navbar-fixed background-less white no-background bootsnav">
    ...
    <!-- Start Banner 
    ============================================= -->
    <div class="banner-area tab-auto-height pt-50p text-default bg-cover shadow dark text-light" style="background-image: url(assets/img/2440x1578.png);">
        <div class="box-table">
            <div class="box-cell">
                <div class="container">
                    <div class="content">
                        <div class="row align-center">
                            <div class="col-lg-7 col-md-12">
                                <h2>Meet the <strong>Best Doctors</strong></h2>
                                <p>
                                    Preference entreaties compliment motionless ye literature. Day behaviour explained law remainder.
                                </p>
                                <a data-animation="animated fadeInUp" class="btn btn-md btn-light border" href="#">Discover More</a>
                            </div>
                            <!-- Start Appoinment Form -->
                            <div class="col-lg-5 col-md-12 appoinment">
    ...
    <!-- Start Departments
    ============================================= -->
    <div class="departments-area default-padding">
        <!-- Shape -->
        <div class="shape">
    ...
    <!-- Start Our Process
    ============================================= -->
    <div class="process-area bg-gray">
        <div class="container">
