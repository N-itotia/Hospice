...
<body>
    ...
    <header id="home">
        ...
        <!-- Start Navigation -->
        <nav class="navbar navbar-default navbar-fixed background-less dark no-background bootsnav">
    ...
    <!-- Start Banner 
    ============================================= -->
    <div class="banner-area tab-auto-height inc-list bg-gradient-mixed pt-50p text-default">
        <div class="box-table">
            <div class="box-cell">
                <div class="container">
                    <div class="content">
    ...
    <!-- Start Link Area
    ============================================= -->
    <div class="link-area inc-border default-padding-top">
        <div class="container">
                    ...
                    <div class="col-lg-6 single-item">
                        <div class="item">
                            ...
                            <div class="info">
                                ...
                                <p>
                                    Possession insensible sympathize boisterous it. Songs he on an widen me event truth. Certain law age brother sending amongst why covered. 
                                </p>
                                <a href="#">Get it now</a>
                            </div>
                        </div>
    ...
    <div class="about-area default-padding-bottom">
        <div class="container">
            <div class="choseus-items">
                <div class="row align-center">
                    <div class="col-lg-6 thumb-box left-thumb">
                        <img src="assets/img/bg-4.png" alt="Thumb">
                    </div>
    ...
    <!-- Start Services Area
    ============================================= -->
    <div class="our-services-area icon-only bg-gray default-padding bottom-less">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 single-item">
                    <div class="item">
                        ...
                        <p>
                            Truth short folly court why she their balls. Excellence put unaffected reasonable mrs introduced conviction.
                        </p>
                ...
                <div class="col-lg-3 col-md-6 single-item">
                    <div class="item">
                        <i class="flaticon-stomachache"></i>
    ...
    <!-- Star Doctors Area
    ============================================= -->
    <div class="doctors-area thumb-full three-colum default-padding bottom-less">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
    ...
    <!-- Start Gallery Area
    ============================================= -->
    <div class="gallery-area bg-gray inc-carousel default-padding">
